  ...
  if (input$modelo_1 == "fundeb") {
    df_1 <-
      simular_modelo_fundeb_tempo(
        ...
        fatores_intra_equidade = as.logical(input$fatores_intra_equidade_1),
        equalizacao_socio = input$equalizacao_socio_1,
        condicao_rede = input$condicao_rede_1,
        desconsidera_estados = input$gov_estado_intraestadual_1,
  ...
  if (input$modelo_2 == "fundeb") {
      df_2 <-
        simular_modelo_fundeb_tempo(
          ...
          fatores_intra_equidade = as.logical(input$fatores_intra_equidade_2),
          equalizacao_socio = input$equalizacao_socio_2,
          condicao_rede = input$condicao_rede_2,
          desconsidera_estados = input$gov_estado_intraestadual_2,
